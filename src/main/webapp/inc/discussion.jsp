            ...
            <div class="col col-md-2 col-sm-2 col-lg-2 center" style="margin-top:50px;">
                ...
                <div class="row">
                    <table class="table">
                        ...
                        <tr><td><form action="voirDiscussion"> <input class="btn btn-block " type="submit" value="Discussion"></form></td></tr>
            ...
            <div class="col col-md-10 col-sm-10 col-lg-10" style="overflow: scroll;margin-top:50px;max-height: 600px;height: 600px">
                ...
                <div class="row panelMessage" style="border: 1px black; background-color: #E6E6FA;">
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="messagePerso.jsp?idExpediteur=2"><h4>Jonathan Kevin</h4></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label>Encore connécté</label><br>
                        <label>Sexe : Homme</label><br>
                    </div>
                    <div class="col-md-4">
                        <img alt="photo" src="image/pdp/connecte.jpg" style="margin-top: 5px;" width="25px" height="15px">	
                    </div>
                </div>
                ...
                <div class="row panelMessage" style="border: 1px black; background-color: #E6E6FA;">
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="messagePerso.jsp?idExpediteur=2"><h4>Rasolomanana Eric</h4></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        <img alt="photo" src="image/pdp/deconnecte.jpg" style="margin-top: 5px;" width="25px" height="15px">	
                    </div>
                </div>
