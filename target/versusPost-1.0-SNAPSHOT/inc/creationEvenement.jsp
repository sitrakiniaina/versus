            ...
            <div class="row" id="center">
                <div class="col col-md-2 col-sm-2 col-lg-2 center" style="margin-top:50px;">
                    ...
                    <div class="row">
                        <table class="table">
                            ...
                            <tr><td><form action="affichageCreationEvenement"> <input class="btn btn-block" type="submit" value="Création Evenement"></form></td></tr>
                ...
                <div class="col col-md-10 col-sm-10 col-lg-10" style="overflow: scroll;margin-top:50px;max-height: 600px;height: 600px">
                    <div class='row' style='margin-top:15px'>
                        ...
                        <h1 style='margin-left: 320px;'>Créer un évènement</h1>
                         <br>
                        <form method="post" action="creerEvenement" role="" class='form-horizontal'>          
                            <div class='row form-group'>
                                <label class='control-label col-md-5 '>Titre :</label>
                                <div class='col-md-7'>
                                    <div class='form-group'>
                                        <div class=''>
                                            <input style='box-shadow:0px 0px 2px grey;width:200px' class='form-control' name='titre' type='text'>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class=' row form-group'>
                                <label class='control-label col-md-5'>Déscription :</label>
                                <div class='col-xs-7'>
                                    <div class='form-group'>
                                        <div class='col-md-11'>
                                            <div class='form-group'>
                                                <textarea style='box-shadow:0px 0px 2px grey;width:200px' class='form-control' name='description'></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!--<div class='row form-group'>
                                <label class='control-label col-md-5 '>Date éxpiration :</label>
                                <div class='col-md-7'>
                                    <div class='form-group'>
                                        <div class=''>
                                            <input style='box-shadow:0px 0px 2px grey;width:200px' class='form-control' name='dateexp' type='date'>
                                        </div>
                                    </div>
                                </div>
                            </div>-->
                            <div class='form-group'>
                                <div class='col-md-3'>
                                    <button style='margin-left: 537px' class='btn btn-primary' type='submit'>Créer</button>
                                </div>
